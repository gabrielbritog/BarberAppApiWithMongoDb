...
namespace BarberApp.Domain.Interface.Services
{
    ...
    {
        public Task<ResponseServiceTypeDto> Register(RegisterServiceTypeDto serviceType, string UserId);
        public Task<ResponseServiceTypeDto> Register(RegisterServiceTypeDto serviceType, string UserId, string barberId);
