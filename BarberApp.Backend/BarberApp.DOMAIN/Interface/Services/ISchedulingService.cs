...
namespace BarberApp.Domain.Interface.Services
{
    public interface ISchedulingService
    {
        ...
        public Task<List<ResponseSchedulingDto>> GetManyByDate(string userId, DateTime startDate, DateTime endDate);
        public Task<List<ResponseSchedulingDto>> GetManyByDate(string userId,string barberId, DateTime startDate, DateTime endDate);
